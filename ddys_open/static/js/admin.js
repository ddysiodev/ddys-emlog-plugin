(function () {
  ...
  function setStatus(form, message, failed) {
    var node = $('.ddys-emlog-admin-status', form) || $('.ddys-emlog-admin-status', form.parentNode || form);
    if (!node) return;
  ...
  function bindAjaxForms() {
    var forms = document.querySelectorAll('[data-ddys-emlog-form], [data-ddys-emlog-tool]');
  ...
  function buildPage(root, tag, limit, page, value) {
    ...
    url.searchParams.set('plugin', 'ddys_open');
