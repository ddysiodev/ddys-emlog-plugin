...
defined('DDYS_OPEN_EMLOG_ID') || define('DDYS_OPEN_EMLOG_ID', 'ddys_open');
defined('DDYS_OPEN_EMLOG_VERSION') || define('DDYS_OPEN_EMLOG_VERSION', '0.1.0');
defined('DDYS_OPEN_EMLOG_API_DEFAULT') || define('DDYS_OPEN_EMLOG_API_DEFAULT', 'https://ddys.io/api/v1');
defined('DDYS_OPEN_EMLOG_SITE_DEFAULT') || define('DDYS_OPEN_EMLOG_SITE_DEFAULT', 'https://ddys.io');
